...
export function Header({ lastUpdatedLabel, isRefreshing }: HeaderProps) {
  return (
    <header className="relative overflow-hidden rounded-3xl border border-[#3a5276] bg-[radial-gradient(circle_at_10%_-10%,rgba(47,125,246,0.45),transparent_35%),linear-gradient(155deg,#1a2b45_0%,#132139_60%,#101d33_100%)] p-8 shadow-[0_35px_90px_rgba(0,0,0,0.45)]">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-2xl">
          <div className="inline-flex items-center gap-3 rounded-full border border-[#4d668d] bg-[#172841] px-4 py-2 text-sm font-medium text-[#ecf4ff]">
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-[#d6e4f8]">
        ...
        <div className="flex min-w-[250px] flex-col gap-3 rounded-2xl border border-[#4d668d] bg-[#172841] p-5">
          <div className="flex items-center gap-3">
            <span
              className={`h-3 w-3 rounded-full ${isRefreshing ? "animate-pulse bg-emerald-400" : "bg-[#3f587a]"}`}
            />
            <span className="text-sm font-medium text-[#ecf4ff]">
              {isRefreshing ? "Refreshing now" : "Live polling every 60s"}
            </span>
          </div>
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#bfd1ea]">
              Last updated
            </p>
